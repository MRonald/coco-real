            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        <h2 class="page-title m-0">Lista de Contas a Receber</h2>
                        <a href="{{ route('bills-in.create') }}" class="btn btn-primary">
                            Criar
                        </a>
                    </div>
                    <div class="row my-4">
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown-item"
                                                                href="{{ route('bills-in.edit', $bill->id) }}">Editar</a>
...
@section('script')
    <script>
        ...
        $(document).delegate('#btnModalDelete', 'click', function() {
            $('#btnConfirmDelete').attr('href', `/admin/bills-in/${$(this).data('item-id')}/delete`);
        });
    </script>
@endsection
