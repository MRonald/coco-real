            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        <h2 class="page-title m-0">Lista de Produtos</h2>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <a class="dropdown-item" id="btnModalDelete" href="#"
                                                                data-item-id="{{ $product->id }}" data-toggle="modal"
...
@section('script')
    <script>
        ...
        $(document).delegate('#btnModalDelete', 'click', function() {
            $('#btnConfirmDelete').attr('href', `/admin/products/${$(this).data('item-id')}/delete`);
        });
    </script>
@endsection
